...
public class StringBufferExam {
	...
	public static void main(String[] args) {
		/*
		 * String은 immutable 즉 변경이 불가능하다.
		 * StringBuffer는 변경이 가능하다.
		 * StringBuffer는 String 유사한 점이 많다.
		 * 객체를 생성할 때 적절한 길이의 char형 배열이 생성되고
		...
		//String 에서는 equals를 오버라이딩해서 문자열의 내용만 비교하도록 구현되어 있다. (true)
		...
		//StringBuffer 에서는 equals를 오버라이딩 하지 않아서 == (주소비교 false) 와 같은 결과 출력
