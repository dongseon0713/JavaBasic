...
public class variableExam {
	...
	public static void main(String[] args) {
		...
		//객체마다 각기 다른 값을 유지할 수 있다. 
		//반면 클래스 변수는 모든 객체들이 하나의 저장 공간을 공유한다. 따라서 항상 같은 공통된 값을 갖는다.
		...
		c1.width = 50;		//c1을 수정하였으나 Card.width 값 도 변경
		c1.height = 150;
		...
		System.out.println("c2 변수 출력 =  " + c2.width);	//Card.width값도 변경 되었기 때문에 c2값도 변경된다.
